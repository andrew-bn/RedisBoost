...
namespace NBoosters.RedisBoost
{
	public partial class RedisClient
	{
		...
		{
			return IntegerResponseCommand(RedisConstants.HSet, key.ToBytes(), field, value);
		}
		...
		{
			return IntegerResponseCommand(RedisConstants.HSetNx, key.ToBytes(), field, value);
		}
		...
		{
			return IntegerResponseCommand(RedisConstants.HExists, key.ToBytes(), field);
		}
		...
		{
			return BulkResponseCommand(RedisConstants.HGet, key.ToBytes(), field);
		}

		public Task<MultiBulk> HGetAllAsync(string key)
		{
			return MultiBulkResponseCommand(RedisConstants.HGetAll, key.ToBytes());
		}
		...
		{
			return IntegerResponseCommand(RedisConstants.HIncrBy, key.ToBytes(), field, increment.ToBytes());
		}
		...
		{
			return BulkResponseCommand(RedisConstants.HIncrByFloat, key.ToBytes(),
				field, increment.ToBytes());
		}

		public Task<MultiBulk> HKeysAsync(string key)
		{
			return MultiBulkResponseCommand(RedisConstants.HKeys, key.ToBytes());
		}

		public Task<MultiBulk> HValsAsync(string key)
		{
			return MultiBulkResponseCommand(RedisConstants.HVals, key.ToBytes());
		}

		public Task<long> HLenAsync(string key)
		{
			return IntegerResponseCommand(RedisConstants.HLen, key.ToBytes());
		}
